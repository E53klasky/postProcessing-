...
def main():
    ...
    while True:
        ...
        # plot_level_general(
        #     progressive_array=progressive,
        #     target_size=best_shape,
        #     shape_sequence=shape_seq,
        #     min_size=8,
        #     full_resolution_shape=data.shape
        # )

        # # Instead of comparing original vs decimated data directly, do:
        # reconstructed_full  = upsample_nearest(level_data, data.shape)
